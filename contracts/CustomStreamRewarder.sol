...
contract CustomStreamRewarder is Ownable{
    ...
    function _provisionReward(uint256 _rewards, address _rewardToken) internal {
        ...
        // Update the constant c of the equaltion so that the reward amount fits in the duration with the given 
        // rate of change of reward rate, formula generated by simple algebra on the integration to get area under rate vz time curve
